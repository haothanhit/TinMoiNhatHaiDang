...
import com.haidang.tinmoinhat.common.abstractViewHolder.BaseViewHolderDetail
...
class AdapterDetail (val arrContent: ArrayList<ModelContent>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolderDetail<*> {
    ...
    inner class AdHolder(itemView: View) : BaseViewHolderDetail<ModelContent>(itemView) {
        override fun bind(item: ModelContent, pos: Int) {
    ...
    override fun onBindViewHolder(holder: BaseViewHolderDetail<*>, position: Int) {
